const products = [
  {
    ...
    prices: [
      { country: "USA", price: 499, currency: "USD", price_usd: 499 },
      { country: "Germany", price: 549, currency: "EUR", price_usd: 586 },
      { country: "Turkey", price: 21999, currency: "TRY", price_usd: 684 },
    ],
  },
  {
    id: "macbook",
    ...
    prices: [
      ...
      { country: "Turkey", price: 45999, currency: "TRY", price_usd: 1431 },
    ],
  },
  {
    id: "echo",
    ...
    prices: [
      { country: "USA", price: 49.99, currency: "USD", price_usd: 49.99 },
      { country: "Germany", price: 59.99, currency: "EUR", price_usd: 63 },
      { country: "Turkey", price: 1999, currency: "TRY", price_usd: 62 },
    ],
  },
  {
    id: "dyson",
    ...
    prices: [
      { country: "USA", price: 749, currency: "USD", price_usd: 749 },
      { country: "Germany", price: 799, currency: "EUR", price_usd: 853 },
      { country: "Turkey", price: 27999, currency: "TRY", price_usd: 871 },
    ],
  },
  {
    id: "instapot",
    ...
    prices: [
      ...
      { country: "Turkey", price: 3499, currency: "TRY", price_usd: 109 },
    ],
  },
];
